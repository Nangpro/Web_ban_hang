                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="">16.Cù Chính Lan.TP Vinh.Nghệ An</a></li>
                            <li><a href="">Hotline: 08439.555.357</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="">Gọi kiếu nại: 09757.5266.xxx</a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="copyright_text">
                            <P>
                                ...
                                </script> <a href="" target="_blank">Banhang</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </P>
                        </div>
                    </div>
