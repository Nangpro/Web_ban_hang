                                    ...
                                    <table class="table">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                <a type="button" class="btn btn-primary btn-icon-text" style="color: red" href="editcategory.php?id=<?= $row['id_dm'] ?>">
                                                <i class="mdi mdi-file-check btn-icon-prepend" style="color: red></i> Sửa </a>
                                                <a type="button" class="btn btn-danger btn-icon-text" style="color: red" href="?id=<?= $row['id_dm'] ?>" onclick="return confirm('Bạn có muốn xóa danh mục này không ?')">
                                                <i class="mdi mdi-delete btn-icon-prepend" style="color: red"></i> Xóa </a>
                                                </td>
                                            </tr>
                                        <?php
                                            }
