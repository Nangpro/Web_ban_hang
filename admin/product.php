                                            ...
                                            <tr class="addfont">
                                                ...
                                                <?php 
                                                  ...
                                                  <?php 
                                                      ...
                                                      ?>
                                                      <a type="button" class="btn btn-success btn-icon-text" style="width: 120px" href="?id=<?= $row['id'] ?>" onclick="return confirm('Bạn có muốn tiếp tục kinh doanh sản phẩm này không?')">
